...
public class LeituraDadosImpl {
    ...
    public static void criarPacoteNovo(SiteTurismo site, Scanner scanner_1) {
        ...
        Pacote pacote = new Pacote(nomePct, dispBoolean, Integer.parseInt(qtdDispPct), destino,
                dataIda, dataVolta, Double.parseDouble(preco), Integer.parseInt(qtdMaxPessoas), idPacote, categoria); // Cria
                                                                                                                      // objeto
    ...
    public static void fazerReserva(SiteTurismo site, Usuario usuario, int idPacote, String dataReserva,
            int qtdPessoas) {
